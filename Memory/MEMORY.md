...
Claude's persistent memory for the Bored and Buzzed engagement. Every file here is live — read at session start. Must stay aligned with [[CLAUDE]]. If memory contradicts the master document, trust CLAUDE.md and update the memory file.
